        ...
        private void SetUserID_Click(object sender, EventArgs e)
        {
            if (IsValidHandle(m_handle_0))
            {
                ...
                if (status == dvpStatus.DVP_STATUS_OK)
                {
                    ...
                    {
                        if (m_info1[item].FriendlyName == m_info1[DevNameCombo1.SelectedIndex].FriendlyName)
                        {
                            EditUserID1.Text = m_info1[item].UserID;
                        }
                    }
                    for (int item = 0; item < 16; item++)
                    {
                        if (m_info2[item].FriendlyName == m_info2[DevNameCombo2.SelectedIndex].FriendlyName)
                        {
                            EditUserID2.Text = m_info2[item].UserID;
                        }
                    }
                    for (int item = 0; item < 16; item++)
                    {
                        if (m_info3[item].FriendlyName == m_info3[DevNameCombo3.SelectedIndex].FriendlyName)
                        {
                            EditUserID3.Text = m_info3[item].UserID;
                        }
                    }
                }
            }
        ...
        private void SetUserID1_Click(object sender, EventArgs e)
        {
            if (IsValidHandle(m_handle_1))
            {
                ...
                if (status == dvpStatus.DVP_STATUS_OK)
                {
                    ...
                    for (int item = 0; item < 16; item++)
                    {
                        if (m_info0[item].FriendlyName == m_info0[DevNameCombo.SelectedIndex].FriendlyName)
                        {
                            EditUserID.Text = m_info0[item].UserID;
                        }
                    }
                    for (int item = 0; item < 16; item++)
                    {
