...
if oceandirect_path not in current_system_path:
    os.environ['PATH'] =oceandirect_path + os.pathsep + current_system_path
# 现在尝试导入
...
import json
from typing import List
from ctypes import c_char, cdll, c_int, c_int32, c_ushort, c_uint, c_long, create_string_buffer, c_ulong, c_ubyte, \
    c_double, c_float, c_longlong, POINTER, byref
from enum import Enum, auto

# 如果sdk_properties.py和od_logger.py在当前目录或Python路径中
try:
    # 直接导入这两个模块
    import sdk_properties
    import od_logger
